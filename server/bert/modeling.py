...
@File: modeling.py.py
@Time: 2020/3/2 2:30 PM
"""

# Some codes come from <bert-as-service>:
#    Author: Han Xiao
...
def embedding_lookup_factorized(input_ids, # Factorized embedding parameterization provide by albert
                     ...
                     use_one_hot_embeddings=False):
    """
    Looks up words embeddings for id tensor, but in a factorized style followed by albert.
    it is used to reduce much percentage of parameters previous exists.
